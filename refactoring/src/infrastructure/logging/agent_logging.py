...
class AgentLogger:
    ...
    def completed(self, duration_ms: float | None = None, message: str = "Completed") -> None:
    ...
    def failed(self, error: str | Exception, message: str = "Failed") -> None:
        """Log agent failure.
...
def log_to_file(log_file: str | Path, message: str) -> None:
...
class AgentCoordinatorLogger:
    ...
    def __init__(
        self, log_file: str | Path | None = None, console_logger: logging.Logger | None = None
    ):
    ...
    def orchestration_complete(
        self, duration_ms: float, success_count: int, total_count: int
    ) -> None:
