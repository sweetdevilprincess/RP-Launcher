...
### SUSPENSE / TENSION SCENES

**When to apply**: Danger, threats, being watched, hunted, mysteries, escalating dread, uncertain threats, atmospheric horror

  **Core Principles**
  - **Information Asymmetry**: Reader/character knows something is wrong but not what/where/when
  - **Environmental Wrongness**: Setting creates unease through specific details
  - **Escalating Threat**: Tension builds through progressive revelations or proximity
  - **Consequence Awareness**: Real stakes with authentic danger

  **Specific Requirements:**
  - Concrete sensory details that create unease (specific sounds, smells, visual wrongness)
  - Character's physical threat response (heightened awareness, adrenaline, freeze/flight)
  - Environmental details that contribute to danger or limit options
  - Progressive revelation of threat (don't show everything at once)
  - Track spatial awareness and escape routes/obstacles

  **Avoid:**
  - Vague "something felt wrong" without specific sensory cues
  - Jump scares without build-up
  - Convenient rescue or safety appearing without setup
  - Making threats feel hollow or consequence-free

  **Example 1 - Being Watched:**
  ...
  **Example 2 - Environmental Threat:**
  > The tavern's usual chatter died the moment the cloaked figure stepped through the door. Not silence—conversations continued—but the pitch dropped. People shifted in their seats to face away. The barkeep's hand drifted below the counter. The fire popped, loud in the sudden quiet, and smoke curled back down from the chimney instead of rising. Wrong. The air pressure had changed.

  **Example 3 - Escalating Danger:**
  > The footsteps matched her pace. When she slowed at the corner shop window, they slowed. When she turned down the alley—the shortcut she'd taken a hundred times—they turned too. Her keys were already out, sharp edges jutting between her knuckles. The streetlight at the alley's end flickered. Once. Twice. Died. The footsteps didn't stop.
